...
export const schoolChallenges = [
  ...
  // },
  {
    ...
    solution:
      "ネットワークに連携可能なインカム・トランシーバー・無線機では、電話との連携も可能であるため、どこにいても外線・内線に発信ができ、着信もできます。またワンプッシュで一斉送信が可能となり、離れた場所にいるスタッフと瞬時に連絡・情報共有が可能になります。※GIGA スクール構想の一環で導入が進んでいます",
    icon: FaExchangeAlt,
  },
  {
    ...
    solution:
      "ネットワークに連携可能なインカム・トランシーバー・無線機の活用によって、ワンプッシュで一斉送信が可能となり、離れた場所にいるスタッフと瞬時に連絡・情報共有が可能になります。他フロアにいるスタッフに対しての応援要請や緊急時の役割分担もスムースに対応可能となります。※GIGA スクール構想の一環で導入が進んでいます",
  ...
  // },
  {
    ...
    solution:
      "ネットワークに連携可能なインカム・トランシーバー・無線機では、インターホンや各種センサー、見守りカメラ、AI カメラとの連携も可能であるため、速やかなアラートや異常検知により現場確認等の移動距離、移動時間が短縮でき、効率的なオペレーションが可能となります。※GIGA スクール構想の一環で導入が進んでいます",
    icon: FaShieldAlt,
  },
  // {
  //   title: "校内の連絡体制が不十分",
